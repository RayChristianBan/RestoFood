...
const Footer = () => {
  return (
    <div className='max-w-[1240px] mx-auto py-16 px-4 grid lg:grid-cols-3 gap-8 text-gray-300'>
      <div>
        <h1 className='w-full text-3xl font-bold text-rose-500'>RestoFood</h1>
        <p className='py-4 text-black'>Our Product are fresh and made after listing the orders. Around Phillipines and Branches.</p>
    ...
    <div>
        ...
        <ul className='text-black font-medium'>
            <li className='py-2 text-sm'>About RestoFood</li>
